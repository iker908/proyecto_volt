...
<html lang="es">
    ...
    <body>
        ...
        <?php
        #las paginas de planes hacen lo mismo que la comparativa pero, pero unicamente para el plan seleccionado
        #y guardando mas datos para mostrarlos
        session_start();
    ...
    $consulta2=mysqli_query($conexion,$comparar);
          while ($valores = mysqli_fetch_array($consulta2)) {
              ...
              #guardamos los datos para la grafica circular
              $datos1 = [
                ['Tipo', 'Precio'],
        ...
        ?>
        <!-- creamos el script que generara las graficas -->
      ...
      function drawChart3() {
        var data = google.visualization.arrayToDataTable(<?php echo json_encode($datos3); ?>);


        var options = {
          title: 'Diferencia de precio de consumos',
          is3D: true,
        };
        ...
        <div class="container">
            ...
            <div class="right">
                ...
                <div class="paquete_grafica" id="chart3">
                </div>
                <div class="item-1">
